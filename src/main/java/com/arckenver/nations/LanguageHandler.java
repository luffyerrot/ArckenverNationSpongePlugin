...
public class LanguageHandler
{
	...
	public static String SUCCESS_ZONESELL = "You sold your zone {ZONE}";
	public static String SUCCESS_BUYYOUROWN = "You can't buy your own zone {ZONE}";
	public static String INFO_ZONEBUY = "{PLAYER} bought you zone {ZONE} for {AMOUNT}";
	public static String ERROR_NO_ACCOUNT = "No account find for deal";
	public static String FAILED_BUYING = "Failed the buying action";
