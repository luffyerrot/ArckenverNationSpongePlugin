...
public class Zone
{
	...
	public Zone(UUID uuid, String name, Cube cube)
	{
		this(uuid, name, cube, null, null);
	}
	
	@SuppressWarnings("serial")
	public Zone(UUID uuid, String name, Cube cube, UUID owner, String playerName)
	{
		this.uuid = uuid;
		this.name = name;
		this.owner = owner;
