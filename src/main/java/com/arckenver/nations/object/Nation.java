...
public class Nation
{
	...
	public Nation(UUID uuid, String name, boolean isAdmin)
	{
		...
		this.regionCube = new RegionCube();
		this.president = null;
	...
	public RegionCube getRegionCube()
	{
		return regionCube;
	}

	public void setRegionCube(RegionCube regionCube)
	{
		this.regionCube = regionCube;
	}
	...
	{
		zones.replace(zone.getUUID(), zone);
	}
